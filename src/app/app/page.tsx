...
const ButtonFallback = () => (
  <div className="h-10 bg-[#8B5CF6]/30 rounded-md animate-pulse w-full"></div>
);
...
const ConnectStoreCard = memo(({ connectionStatus, isConnecting, startOAuthFlow }: ConnectStoreCardProps) => (
...
interface RecommendationRowProps {
  ...
  fetchRecommendationDetail: (id: string) => Promise<void>;
  user: User | null;
}

// Memoized recommendation row component
                    ...
                    <div className="mt-4">
                      ...
                      <div className="space-y-3">
                        {selectedRecommendation.implementation_emails.map((email, index) => (
                          <div key={`email-${rec.id}-${index}`} className="bg-white p-4 rounded-md">
                      ...
                      {recommendations.map((rec) => {
                        ...
                        return (
                          <RecommendationRow
                            ...
                            fetchRecommendationDetail={fetchRecommendationDetail}
                            user={user}
                          />
                        );
                      })}
